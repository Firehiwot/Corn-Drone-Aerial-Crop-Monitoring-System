...
<br>
 ...
 <ul>
    <li> Type raspi-config in the console
    <li> Go down to advanced options and hit enter
    <li> Go down to Serial and hit enter
    <li> You will be asked the first question below and select No
